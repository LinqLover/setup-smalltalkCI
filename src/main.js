...
const DEFAULT_32BIT_DEPS = `libc6-i386 libgl1:i386 libuuid1:i386 libxrender1:i386 zlib1g:i386${UBUNTU_VERSION == 18 ? ' libssl1.0.0:i386' : UBUNTU_VERSION == 20 ? ' libssl1.1:i386' : ''}`
